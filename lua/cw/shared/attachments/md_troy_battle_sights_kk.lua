...
if CLIENT then
	...
	function att:elementRender()
		...
		local correctMDL = (self.AttachmentModelsVM.md_troyfrontsight_kk != nil) and (self.AttachmentModelsVM.md_troyrearsight_kk != nil)
		if correctMDL then
			correctMDL = correctMDL and (self.AttachmentModelsVM.md_troyfrontsight_kk.model == "models/c_troy_sight_front.mdl")
			correctMDL = correctMDL and (self.AttachmentModelsVM.md_troyrearsight_kk.model == "models/c_troy_sight_rear.mdl")
		end
		if correctMDL then
